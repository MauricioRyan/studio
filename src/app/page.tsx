  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      const mockConfig: SystemConfig[] = [
        ...
        {name: 'Contenidos', description: 'Herramienta para compartir archivos (cualquier tipo) es temporario y económico (gratis)', url: 'https://ccn.pjm.gob.ar/'},
        {name: 'Firmador Digital', description: 'Firmador digital Oficial del Poder Judicial', url: 'https://signer-fe.pjm.gob.ar/firmar'},
        {name: 'Verificación Firmada Digital', description: 'Verificador Oficial de firma digital en PDFs', url: 'https://signer-fe.pjm.gob.ar/verificar'},
        ...
        {name: 'ConcilIA', description: 'ConcilIA ', url: 'https://concilia.pjm.gob.ar/'},
        ...
        {name: 'Registro de Evidencia Digital', description: 'Registro de Evidencia Digital ', url: 'https://red.pjm.gob.ar/'},
